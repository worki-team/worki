...
class _JobsPageState extends State<JobsPage> {
  ...
  Widget _companyCard(Company company) {
    return GestureDetector(
      onTap: () {
        ...
        Navigator.pushNamed(context, 'companyDetails',arguments: {'company':company,'user':worker});
      },
      child: Container(
        width: 90,
        child: Column(
  ...
  Widget _slidingPanel(ScrollController sc, PanelController _panelController){
    return FilterCardWidget(panelController: _panelController,sc: sc,user: worker,push: true);
  }
}
