...
class _HomePageState extends State<HomePage> {
  ...
  Widget _nextJob(Job job) {
    return Column(
      ...
      children: <Widget>[
        ...
        NextJobWidget(
          panelController: _panelController, job:job, user: worker,
        ),
      ],
    );
  }
                ...
                children: <Widget>[
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            GestureDetector(
                              onTap: (){
                                 Navigator.of(context).pushNamed('worker_jobs_page',arguments: {'user':worker, 'jobs': jobs});
                              },
                              child: Icon(
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, i) => _nextJobCard(jobs[i], i),
                    ),
                  ),
                ],
              );
    ...
    return FutureBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        if(snapshot.hasData){
          ...
          return QrGeneratorWidget(panelController: _panelController,sc: sc,user: worker, job:job,push: true);
        }else{
          return Container();
        }
      },
  ...
  Widget _calendarPanel(List<Job> jobs){
    return AnimatedContainer(
      ...
      height: _showCalendar == false ? 0 : null,
      child: AnimatedOpacity(
        duration:_showCalendar == false ? Duration(milliseconds:200) : Duration(milliseconds:1200),
        opacity:_showCalendar == false ? 0 : 1.0,
