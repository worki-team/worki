          ...
          onPressed: () {
            if (_formKey.currentState.validate()) {
              ...
              if (rol == 'WORKER') {
                ...
                //Navigator.push(context, MaterialPageRoute(builder: (_) => new RegisterUser3Page(info: {'user':user.toJson(), 'companyId':info['companyId']})));
              }
  ...
  Widget _dateBirthInput() {
    return new ListTile(
      ...
      title: new DateTimeField(
        ...
        onSaved: (value) => user.birthDate = value,
        onFieldSubmitted: (_) {
          fieldFocusChange(context, _phoneFocusNode, _dateBirthFocusNode);
        },
      ),
