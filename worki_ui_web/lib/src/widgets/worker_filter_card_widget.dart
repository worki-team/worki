...
class FilterWorkerCardWidget extends StatefulWidget {
  ...
  final user;
  bool push;
  FilterWorkerCardWidget({this.panelController, this.sc, this.user, @required this.push});

  @override
  _FilterWorkerCardWidgetState createState() => _FilterWorkerCardWidgetState(panelController: this.panelController, sc: this.sc, user: this.user, push: this.push);
}
...
class _FilterWorkerCardWidgetState extends State<FilterWorkerCardWidget> {
  ...
  _FilterWorkerCardWidgetState({this.panelController, this.sc, this.user, this.push});
    ...
    return Padding(
      ...
      child: ListView(
        ...
        DropdownButton(
          ...
          itemHeight: 50.0,
          items: <String> ['Inglés','Alemán','Francés','Portugués','Italiano','Mandarín','Japonés','Ruso','Otro','']
              .map<DropdownMenuItem<String>>((String value) {
            return DropdownMenuItem<String>(value: value, child: Text(value));
          }).toList(),
          onChanged: (newValue) {
        ...
        DropdownButton(
          ...
          itemHeight: 50.0,
          items: <String> ['Logística','Danzas','Actuación','Conducción','Música','Luces y Sonido','Catering','Bartender','Recreación','Otro','']
              .map<DropdownMenuItem<String>>((String value) {
            return DropdownMenuItem<String>(value: value, child: Text(value));
          }).toList(),
          onChanged: (newValue) {
        ...
        Center(
          child: GestureDetector(
            onTap: () async {
              ...
              if(push){
                panelController.close();
                Navigator.of(context).pushNamed('workers_page', arguments: {'arguments':arguments,'user':user});
              }else{
