...
class Worker extends User {
  ...
  Worker.fromJson(Map<String, dynamic> json) {
    ...
    workExperience      = json['workExperience'] != null ? WorkExperiences.fromJsonList(json['workExperience']).items : [];
    education           = json['education'] != null ? Educations.fromJsonList(json['education']).items : [];
    ...
    reportSalary        = json['reportSalary'];
    reportJobs          = json['reportJobs'] != null ? json['reportJobs'].cast<String>() : [];
  }
