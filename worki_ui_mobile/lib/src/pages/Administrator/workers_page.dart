...
class WorkersPage extends StatefulWidget {
  ...
  const WorkersPage({@required this.admin,@required this.company});

  @override
  _WorkersPageState createState() => _WorkersPageState(admin: this.admin,company:this.company);
}

class _WorkersPageState extends State<WorkersPage> {
  Administrator admin;
  Company company;
  _WorkersPageState({this.admin,this.company});
    ...
    return Scaffold(
      ...
      appBar: _arguments['arguments'] !=null ? 
        AppBar(
          backgroundColor: Colors.white,
          elevation: 0.0,
          title: Text('Búsqueda', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold),),
          centerTitle: true,
  ...
  Widget _builderWorkers() {
    return FutureBuilder(
        future: _attributes == null ? workerProvider.getWorkers() : workerProvider.getFilteredWorkers(_attributes),
            ...
            return Padding(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return WorkerCardWidget(worker: workers[index],user:admin);
                  }),
            );
          } else {
            return Padding(
        ...
        children: <Widget>[
          Text(
           ...
           IconButton(
            ...
            onPressed: () {
              Navigator.of(context).pushNamed('face_comparing', arguments: {'admin': admin, 'company': company});
            },
          ),
          IconButton(
  ...
  Widget _slidingPanel(ScrollController sc, PanelController _panelController){
    return FilterWorkerCardWidget(panelController: _panelController,sc: sc,user: admin,push: _attributes==null?true:false);
  }
}
