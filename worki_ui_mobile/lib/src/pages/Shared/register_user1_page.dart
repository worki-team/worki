                  ...
                  Form(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        user.roles[0] == 'ADMINISTRATOR' || user.roles[0] == 'COORDINATOR'? 
                        Container():
                        Text(
                          'Registrate con: ',
                          style: TextStyle(
                ...
                onPressed: () {
                  if (_formKey.currentState.validate()) {
                    ...
                    if(rol == 'WORKER'){
                      ...
                      materialPageRoute = MaterialPageRoute(builder: (_) => new RegisterUser2Page(info: {'user':user.toJson(), 'companyId':params['companyId'],'admin':params['admin']}));
                    }
