  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0.0,
        centerTitle: true,
        title: Text('Crear trabajo en ' + event.name,
      ...
      title: DateTimeField(
        ...
        onShowPicker: (context, currentValue) {
          return showDatePicker(
              context: context,
              firstDate: event.initialDate,
              initialDate: currentValue ?? DateTime.now(),
              lastDate: event.finalDate);
        },
    ...
    return Column(
      children: <Widget>[
            ...
            onPressed: () {
              setState(() {
                if (_jobFunction.text != '') {
                  _functions.add(_jobFunction.text);
                  _jobFunction.text = '';
                }
              });
              //notifyParent();
        ...
        AnimatedContainer(
          ...
          height: _functions.length == 0 ? 0 : 50,
              ...
              itemBuilder: (context, i) {
                return Padding(
                  ...
                  child: Chip(
                    ...
                    label: Text(_functions[i]),
                    onDeleted: () {
                      setState(() {
                        _functions.remove(_functions[i]);
                      });
                    },
                  ),
                );
                  ...
                  FlatButton(
                      onPressed: () async {
                        Navigator.of(context)
                            .popUntil(ModalRoute.withName('admin_main'));
                      },
                      child: Text('Ok')),
                ],
              );
