...
class _PersonalReferencesPageState extends State<PersonalReferencesPage> with TickerProviderStateMixin {
  ...
  Widget _experience() {
    return Column(
      children: <Widget>[
        ...
        ListView.builder(
        itemCount: worker.workExperience != null ? worker.workExperience.length : new List<WorkExperience>(),
